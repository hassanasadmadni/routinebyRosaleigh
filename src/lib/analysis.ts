  ...
  const am: RoutineStep[] = [
    {
      productId: "strips",
      reason:
        "Take one strip 30 minutes after breakfast — place under the tongue and let it dissolve in 30 seconds. Active ingredients absorb directly into the bloodstream, supporting collagen production and skin renewal throughout the day.",
    },
    {
      productId: "day-cream",
      reason:
